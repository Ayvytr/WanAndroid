...
class ApiClient private constructor() {
    ...
    private val loggingInterceptor = LoggingInterceptor(LoggingLevel.SINGLE)
    /**
     * Init [ApiClient].
    ...
    fun init(
        ...
        loggingLevel: LoggingLevel = LoggingLevel.SINGLE,
    ...
    fun setLogLevel(loggingLevel: LoggingLevel) {
        loggingInterceptor.setLevel(loggingLevel)
    }
