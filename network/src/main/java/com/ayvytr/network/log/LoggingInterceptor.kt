...
class LoggingInterceptor @JvmOverloads constructor(
    level: LoggingLevel? = LoggingLevel.SINGLE,
    ...
    private fun logIntercept(chain: Interceptor.Chain): Response {
        ...
        val response: Response = try {
            ...
            Response.Builder().message("UnknownHostException").request(request)
     ...
     * @return 请求状态字符串.
     */
    private fun getHttpHeaderString(
        request: Request, response: Response,
        tookMs: Long,
     ...
     * @return 请求状态字符串.
     */
    private fun getHttpStateString(
        request: Request, response: Response,
        tookMs: Long,
        chain: Interceptor.Chain
    ): String {
